...
export default function DepartmentAdd() {
    ...
    const [transactionLoss, setTransactionLoss] = useState("0.00");
                            ...
                            <TabsContent value="windmill_details" className="mt-0 space-y-6 pt-2">
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                    ...
                                    <div className="space-y-1.5">
                                        ...
                                        <Input placeholder="Enter WM Number" className="bg-white border-slate-300 h-9 text-xs" />
                                    </div>
                                    <div className="space-y-1.5">
                                        <label className="text-sm font-semibold text-slate-700">Windmill Name</label>
                                        <Input placeholder="Enter Windmill Name" className="bg-white border-slate-300 h-9 text-xs" />
                                    </div>
                                    <div className="space-y-1.5">
                                    ...
                                    <div className="space-y-1.5">
                                        ...
                                        <Input placeholder="Enter AE Number" className="bg-white border-slate-300 h-9 text-xs" />
                                    </div>

                                    <div className="space-y-1.5">
                                        <label className="text-sm font-semibold text-slate-700">Operator Name</label>
                                        <Input placeholder="Enter Operator Name" className="bg-white border-slate-300 h-9 text-xs" />
                                    </div>
                                    <div className="space-y-1.5">
                                        <label className="text-sm font-semibold text-slate-700">Operator Number</label>
                                        <Input placeholder="Enter Contact Number" className="bg-white border-slate-300 h-9 text-xs" />
                                    </div>
                                </div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-x-6 gap-y-4 pt-4 border-t border-slate-100">
                                        ...
                                        <div className="space-y-1.5">
                                            ...
                                            <Input placeholder="Enter Vendor Name" className="bg-white border-slate-300 h-9 text-xs" />
                                        </div>
                                        <div className="space-y-1.5">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-x-6 gap-y-4 pt-4 border-t border-slate-100">
                                        ...
                                        <div className="space-y-1.5">
                                            ...
                                            <Input placeholder="Enter Policy Number" className="bg-white border-slate-300 h-9 text-xs" />
                                        </div>
                                        <div className="space-y-1.5">
                                            <label className="text-sm font-semibold text-slate-700">Insurance Company Name</label>
                                            <Input placeholder="Enter Insurance Company Name" className="bg-white border-slate-300 h-9 text-xs" />
                                        </div>
                                        <div className="space-y-1.5">
                                            <label className="text-sm font-semibold text-slate-700">Insurance Company Number</label>
                                            <Input placeholder="Enter Insurance Company Number" className="bg-white border-slate-300 h-9 text-xs" />
                                        </div>
                                        <div className="space-y-1.5">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-x-6 gap-y-4 pt-4 border-t border-slate-100">
                                        <div className="space-y-1.5">
                                            ...
                                            <Input placeholder="Enter Min Level Generation" className="bg-white border-slate-300 h-9 text-xs" />
                                        </div>
                                        <div className="space-y-1.5">
                                        ...
                                        <div className="space-y-1.5">
                                            ...
                                            <Input placeholder="Enter Website URL" className="bg-white border-slate-300 h-9 text-xs" />
                                        </div>
                                        <div className="space-y-1.5">
                                            <label className="text-sm font-semibold text-slate-700">Username</label>
                                            <Input placeholder="Enter Username" className="bg-white border-slate-300 h-9 text-xs" />
                                        </div>
                                        <div className="space-y-1.5">
                                            <label className="text-sm font-semibold text-slate-700">Password</label>
                                            <Input type="text" placeholder="Enter Password" className="bg-white border-slate-300 h-9 text-xs" />
                                        </div>
                                </div>
                            </TabsContent>
