...
// Mock Data
const meetingsData = [
    { id: "1", name: "Team Sync", date: "25-03-2026", department: "IT", participants: "John Doe, Jane Smith", isRecurrence: "Yes", recurrenceType: "Weekly", status: "Saved", isActive: true },
    { id: "2", name: "Project Review", date: "26-03-2026", department: "Finance", participants: "Mike Johnson, Sarah Williams", isRecurrence: "No", recurrenceType: "-", status: "Posted", isActive: false },
    { id: "3", name: "HR Planning", date: "27-03-2026", department: "HR", participants: "Robert Brown", isRecurrence: "Yes", recurrenceType: "Monthly", status: "Saved", isActive: true },
];
            ...
            <div className="w-full bg-white rounded-lg shadow-sm border border-slate-200 overflow-hidden">
                <div className="p-3 space-y-2">
                    ...
                    <div className="flex items-center justify-between pb-2">
                        <h1 className="text-xl font-bold text-slate-800">Meetings Master - List</h1>
                    </div>
                    ...
                    <div className="space-y-1">
                        <div className="p-2 bg-slate-50 border border-slate-200 rounded-lg flex flex-wrap gap-2 items-center">
                            ...
                            <Button size="sm" className="h-9 text-sm bg-emerald-600 hover:bg-emerald-700 text-white px-4" onClick={() => navigate("/master/meetings/add")}>
                                + New
                            </Button>
                    ...
                    <div className="space-y-2">
                        <div className="flex justify-between items-center bg-primary/5 p-2 rounded-t-lg border-b border-primary/10 h-10">
                            <div className="flex items-center gap-4 pl-2">
                                <h2 className="text-sm font-semibold text-primary">Meetings Data</h2>
                            </div>
                        ...
                        <div className="border border-slate-200 rounded-b-lg overflow-hidden mt-0">
                            <Table>
                                <TableHeader className="bg-sidebar">
                                    <TableRow>
                                        <TableHead className="font-semibold text-white h-10 whitespace-nowrap">Meeting Name</TableHead>
                                        ...
                                        <TableHead className="font-semibold text-white h-10 whitespace-nowrap">Recurrence</TableHead>
                                        <TableHead className="font-semibold text-white h-10 whitespace-nowrap">Type</TableHead>
                                    ...
                                    {filteredData.length > 0 ? (
                                        filteredData.map((row, index) => (
                                            <TableRow key={index} className="hover:bg-slate-50 bg-white">
                                                ...
                                                <TableCell className="py-2 text-sm">{row.isRecurrence}</TableCell>
                                                <TableCell className="py-2 text-sm">{row.recurrenceType}</TableCell>
                                                ...
                                                <TableCell className="py-2 text-center">
                                                    <div className="flex justify-center gap-4 items-center">
                                                        <Button variant="ghost" size="icon" className="h-6 w-6 text-primary hover:text-primary hover:bg-primary/10" onClick={() => navigate(`/master/meetings/edit/${row.id}`)}>
