...
export default function MomAdd() {
    const navigate = useNavigate();
    const [meeting, setMeeting] = useState("");
    const [status, setStatus] = useState("");
    const [remarks, setRemarks] = useState("");
    const [continueNextWeek, setContinueNextWeek] = useState(false);
        ...
        <div className="p-3 bg-slate-50 min-h-screen font-sans">
            <div className="w-full bg-white rounded-lg shadow-sm border border-slate-200 overflow-hidden">
                <div className="px-4 py-3 border-b border-slate-100 flex justify-between items-center bg-slate-50/50">
                    <h1 className="text-lg font-semibold text-indigo-700">Minute of meeting - Add</h1>
